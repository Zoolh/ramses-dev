    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="panel panel-default">
		...
		<div class="table-title">
            <div class="row">
                <div class="col-sm-12"><h3 style="color:white;">Création d'un organisme</h3></div>
            </div>
        </div>
          ...
          <form class="form-horizontal row-border" method="POST" action="action_creerStructure.php">
            ...
            <div class="form-group">
              ...
              <div class="col-md-10">
				...
				<input id="nomStructure" name="nomStructure" placeholder="" class="form-control "  value="" type="text" >
				</div>
              </div>
            </div>
				  ...
				  <?php
					...
					if ($result->num_rows > 0) {
						while($row = $result->fetch_assoc()) {
							...
							echo "<optgroup label='".htmlspecialchars($nomdudomaine, ENT_QUOTES, 'UTF-8')."'>";
                ...
                <div class="row">
                  <div class="col-xs-5">
					  <div class="input-group"><span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span>
						<input type="text" name="adresse" class="form-control" placeholder="N° Rue">
					  </div>
                  </div>
                  <div class="col-xs-4">
					  <div class="input-group"><span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span>
			...
			<hr />
			 ...
			 <div class="form-group">
              ...
              <div class="col-md-10">
			  				<textarea class="form-control" rows="3" id="comment" name="horaires"></textarea>
              </div>
            </div>
